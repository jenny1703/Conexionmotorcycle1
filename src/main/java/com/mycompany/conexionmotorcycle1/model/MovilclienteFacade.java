 ...
 */
@Stateless
public class MovilclienteFacade extends AbstractFacade<Movilcliente> implements MovilclienteFacadeLocal {
    ...
    public MovilclienteFacade() {
        super(Movilcliente.class);
    }
