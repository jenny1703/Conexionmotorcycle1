 ...
 */
@Stateless
public class MovilusuarioFacade extends AbstractFacade<Movilusuario> implements MovilusuarioFacadeLocal {
    ...
    public MovilusuarioFacade() {
        super(Movilusuario.class);
    }
